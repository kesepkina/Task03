...
/*ќпределить количество элементов последовательности натуральных чисел, кратных числу ћ и заключенных в
...
public class Task13 {
	...
	public static void main(String[] args) {
		...
		System.out.println(" оличество элементов последовательности натуральных чисел, кратных числу " + m
