...
/*¬ массиве целых чисел с количеством элементов n найти наиболее часто встречающеес€ число. ≈сли таких чисел
...
public class Task19 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Ќаиболее часто встречающеес€ число равно " + TheMostFrequent(mas));
